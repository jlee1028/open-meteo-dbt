...
#### Seeds
- **weather__weather_codes** provides weather code reference data obtained from [meteomatics.com](https://www.meteomatics.com/en/api/available-parameters/weather-parameter/general-weather-state/)
